package com.wlajo.horoscapp.ui.detail

import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.wlajo.horoscapp.domain.model.HoroscopeModel
import com.wlajo.horoscapp.domain.usecase.GetPredictionUseCase
    ...
    fun getHoroscope(sign: HoroscopeModel) {
        ...
        viewModelScope.launch {
            ...
            if (result != null) {
                ...
                _state.value = HoroscopeDetailState.Error("There is an error. Try again")
            }
        }
    }
}